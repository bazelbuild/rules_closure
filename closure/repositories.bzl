...
def com_google_javascript_closure_compiler():
    java_import_external(
        ...
        jar_urls = [
            "https://mirror.bazel.build/repo1.maven.org/maven2/com/google/javascript/closure-compiler-unshaded/v20181125/closure-compiler-unshaded-v20181125.jar",
            "http://repo1.maven.org/maven2/com/google/javascript/closure-compiler-unshaded/v20181125/closure-compiler-unshaded-v20181125.jar",
        ],
        jar_sha256 = "eefaae7d6b2fc846ef10834b1f08f148a306c48f8105466fac0bb7451a3b2409",
        deps = [
            "@com_google_code_gson",
            "@com_google_guava",
            "@com_google_code_findbugs_jsr305",
